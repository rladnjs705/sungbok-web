...
public class R2DirectConnectionTest {
    ...
    @Test
    public void testDirectR2Connection() {
        System.out.println("=== R2 직접 연결 테스트 시작 ===");
        ...
        try {
            ...
            // 3. 테스트 파일 업로드
            String testKey = "test/r2-direct-test-" + UUID.randomUUID().toString().substring(0, 8) + ".txt";
            String testContent = "R2 Direct Test at " + Instant.now().toString();
